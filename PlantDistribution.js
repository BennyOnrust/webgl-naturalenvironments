PlantDistribution = function(worldScale, worldWidth, worldDepth, worldHeightScale, heightData, heightDataInterpolated) {
...
PlantDistribution.prototype.calculateMaxHeight = function(data) {
        var max = -Infinity; 
        var min = +Infinity;
